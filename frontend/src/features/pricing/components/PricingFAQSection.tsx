...
export function PricingFAQSection() {
  ...
  return (
    <section aria-labelledby="pricing-faq-heading" className="border-b border-border bg-surface">
      <div className="mx-auto max-w-3xl px-6 py-16 md:py-20 lg:py-30">
        <FadeUp>
          <h2 id="pricing-faq-heading" className="mb-8 text-3xl font-semibold text-foreground">
